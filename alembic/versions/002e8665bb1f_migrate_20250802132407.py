"""migrate-20250802132407

Revision ID: 002e8665bb1f
Revises: 
Create Date: 2025-02-08 13:24:08.754065
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('USER', 'ADMIN', 'SUPER_ADMIN', name='roletype'), nullable=False),
